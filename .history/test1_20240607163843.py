...
class SWAT_UQ():
    ...
    def _subprocess(self, input_x, id):
        ...
        process= subprocess.Popen(
            ...
            text=True)
        process.wait()
        TN=read_simulation(os.path.join(work_path, "output.rch"), 48, 60, 62, 1560, 1622)
        TP=read_simulation(os.path.join(work_path, "output.rch"), 49, 60, 62, 1560, 1622)
        return (TN, TP)
...
swat_cup=SWAT_UQ(work_path=file_path,
                    ...
                    swat_exe_name="Rev_692_64rel.exe",
