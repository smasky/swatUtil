...
plt.plot(dates, data[:,1], color='#151515', linewidth=2)
plt.plot(dates, data[:,2], color='#151515', linewidth=2)
plt.plot(dates, data[:,3], color='#151515', linewidth=2)
plt.plot(dates, data[:,4], color='#151515', linewidth=2)
plt.plot(dates, data[:,5], color='#151515', linewidth=2)
plt.plot(dates, data[:,6], color='#151515', linewidth=2)
interval = 2
