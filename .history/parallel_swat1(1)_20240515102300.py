...
Date: 2024-05-15 10:20:26
LastEditTime: 2024-05-15 10:23:00
LastEditors: smasky
Description: 
FilePath: \temp_0515\parallel_swat1(1).py
...
if __name__=="__main__":
    ...
    for work_temp in work_temp_dirs:
        shutil.copytree("D:\swat2\TxtInOut", work_temp)
    ...
    # X=lhs.sample(nt=3000, nx=swat_cups[1].n_input)
